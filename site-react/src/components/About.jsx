...
export default function About() {
  ...
  return (
    <>
      <div className="container py-96 overflow-hidden">
        <h2 className='font-bold text-2xl mb-7 bebas abt-heading text-center'>About</h2>
        ...
        <div className="w-full lg:w-1/2 mx-auto">
          ...
          <div class="indicator w-full my-5 about-text">
            <span class="indicator-item badge  badge-outline text-xs">KAGIISO</span>
            <div class=" w-full bg-base-300 place-items-center py-8 px-3 italic"><p className='text-center'>“The songs of these artists make one believe that love really exists. I am marvelled at how they create beautiful well composed music. This is what I want people to feel when they listen to my music.”</p></div>
          </div>
          ...
          <div class="indicator w-full my-5 about-text">
            <span class="indicator-item badge badge-outline text-xs">KAGIISO</span>
            <div class=" w-full bg-base-300 place-items-center py-8 px-3 italic"><p className='text-center'> ⁠”Music evokes memories and emotions. It can touch hearts and shape them in a positive way.”
            </p></div>
          </div>
        </div>
